<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentfee.aspx.cs" Inherits="BijayBharati19030824.studentfee" %>
...
<body class="container p-3 my-3 bg-dark text-white">
    ...
    <form id="form1" runat="server">
        <div class="mt-5">
            <h1 class="display-1 mt-5">Student Fee Details</h1>
            <asp:GridView class="table table-striped table-dark" ID="gvSF" runat="server">
            </asp:GridView>
        </div>
